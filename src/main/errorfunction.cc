...
Data ErrorFunction::GetError(const Vector<Matrix<Data> > &a_vector_matrix,
                             const Vector<Matrix<Data> > &t_vector_matrix) const {
    Vector<Matrix<Data> > e_vector_matrix = t_vector_matrix,
                          e_vector_matrix_mid = t_vector_matrix;
    return GetError(a_vector_matrix, t_vector_matrix, e_vector_matrix,
                    e_vector_matrix_mid);
}
